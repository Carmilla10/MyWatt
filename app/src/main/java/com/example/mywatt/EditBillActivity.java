...
public class EditBillActivity extends AppCompatActivity {
    ...
    private Spinner spinnerEditRebate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinnerEditRebate.setAdapter(rebateAdapter);
        ...
        btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String rebateStr = String.valueOf((int)currentRebate) + "%";
                String[] rebates = {"0%", "1%", "2%", "3%", "4%", "5%"};
                for (int i = 0; i < rebates.length; i++) {
                    if (rebates[i].equals(rebateStr)) {
                        spinnerEditRebate.setSelection(i);
                        break;
                    }
                }
        ...
        btnCancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // CHANGE TITLE BACK TO "Bill Details"
                tvTitle.setText("Bill Details");
                setTitle("Bill Details");
            }
        });

        // Real-time calculation when units change
        ...
        if (!unitsStr.isEmpty()) {
            try {
                ...
                if (units >= 1 && units <= 1000) {
                    String rebateStr = spinnerEditRebate.getSelectedItem().toString();
